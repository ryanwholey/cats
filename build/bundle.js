...
/***/ function(module, exports, __webpack_require__) {
	...
	var _content = __webpack_require__(373);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentWillMount() {
	      _store2.default.dispatch(actions.getPictures());
	      _store2.default.dispatch(actions.getFacts());
	    }
	  }, {
	    key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _catList = __webpack_require__(383);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var changeState = exports.changeState = function changeState(input) {
	  return {
	    type: 'STATE_CHANGE',
	    payload: input
	  };
	...
	var getPictures = exports.getPictures = function getPictures() {
	  return function (dispatch) {
	    return fetch('http://localhost:8000/pics').then(function (response) {
	      if (!response.ok) {
	        throw new Error('Signup failure: ', response);
	      }
	      return response.text();
	    }).then(function (body) {
	      var xmlChild = $.parseXML(body).getElementsByTagName('images')[0].childNodes;
	      return Array.prototype.slice.call(xmlChild).filter(function (item) {
	...
	var getFacts = exports.getFacts = function getFacts() {
	  return function (dispatch) {
	    return fetch('http://localhost:8000/facts').then(function (response) {
	      if (!response.ok) {
	        throw new Error('Signup failure: ', response);
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _kittens_jumbo = __webpack_require__(382);

	var kitten = _interopRequireWildcard(_kittens_jumbo);
	...
	exports.default = function () {
	  return {
	    render: function render() {
	      return _react2.default.createElement(
	        'div',
	        { id: '__header__', className: 'jumbotron' },
	        _react2.default.createElement(
	          'h3',
	          { className: 'center-text' },
	          'Cat facts for humans about cats!!'
	        )
	      );
	    }
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "kittens_jumbo.jpg";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cat = __webpack_require__(384);
	...
	var CatList = function (_Component) {
	  ...
	  function CatList() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(CatList).apply(this, arguments));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cat = function (_Component) {
	  ...
	  function Cat(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Cat).call(this, props));
	  }
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/ryanwholey/Work/cats/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "cat.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./cat.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./cat.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
